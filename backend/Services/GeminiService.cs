...
ВАЖНО: Выбери ОДНУ категорию из списка. Используй категорию ""Другое"" ТОЛЬКО если обращение НЕ подходит ни под одну другую категорию.

Доступные категории и их описание:
1. ""Имущественные преступления"" - кражи, грабежи, мошенничество, угон имущества
2. ""Транспорт и ПДД"" - ДТП, нарушения правил дорожного движения, парковка
3. ""Общественный порядок"" - хулиганство, драки, шум, нарушение тишины
4. ""Бытовые конфликты"" - семейные ссоры, соседские конфликты, споры
5. ""Угрозы и безопасность"" - угрозы жизни, насилие, вымогательство, преследование
6. ""Киберпреступления"" - мошенничество в интернете, взлом аккаунтов, кража данных
7. ""Наркотики"" - незаконный оборот наркотиков, подозрение в распространении
8. ""Экология и животные"" - жестокое обращение с животными, экологические нарушения
9. ""Пропавшие люди"" - розыск пропавших без вести, поиск людей
10. ""Другое"" - ТОЛЬКО если не подходит НИ ОДНА категория выше

Правила определения приоритета:
- ""Высокий"" - угроза жизни, насилие, тяжкие преступления
- ""Средний"" - кражи, мошенничество, конфликты
- ""Низкий"" - консультации, незначительные нарушения

Верни только JSON (без markdown разметки):
{{
    ""Category"": ""название категории точно как в списке"",
    ""Summary"": ""краткое резюме обращения (1-2 предложения)"", 
    ""Sentiment"": ""Негативный/Нейтральный/Положительный"",
    ""Priority"": ""Высокий/Средний/Низкий"",
    ""SuggestedAction"": ""рекомендуемые действия для сотрудника""
}}";
                ...
                var requestBody = new
                {
                    ...
                    {
                        temperature = 0.3,  // Снижаем температуру для более точной классификации
                        topK = 40,
                        topP = 0.9,
